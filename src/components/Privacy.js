...
<ul>
  ...
  <li><strong>What your servers see about this device.</strong> Like every Plex, Jellyfin, and Emby client, Chroma identifies itself to the servers you connect to with a random identifier it generates on first launch (it is not tied to your Apple ID or hardware), the app name and version, and a device label such as &ldquo;Apple Vision Pro&rdquo; so the device shows up sensibly in your server&rsquo;s device list. The same identifier is sent to plex.tv during Plex sign-in. These values go only to plex.tv and to servers you add; they are never sent to us or to any analytics service.</li>
...
<ul>
  <li><strong>No personal data collected.</strong> CrossPort does not collect, store, or transmit any personal information. There are no user accounts, no login, and no analytics.</li>
  <li><strong>Local device communication only.</strong> CrossPort communicates exclusively with your e-reader device over your local WiFi network. No data is sent to our servers.</li>
  <li><strong>Book metadata.</strong> CrossPort fetches publicly available book information (covers, titles, descriptions) from Open Library, Apple Books (iTunes API), and Google Books to enrich your library display. Only book titles and author names are sent to these services &mdash; no personal data.</li>
  <li><strong>On-device storage.</strong> Reading history, book files, wallpapers, and cached metadata are stored locally on your device and are not accessible to us.</li>
  <li><strong>No tracking or advertising.</strong> CrossPort contains no analytics SDKs, no advertising frameworks, and no tracking of any kind.</li>
</ul>
...
<ul>
  <li><strong>Service.</strong> Service means the https://snacksaftermidnight.com website, the Chroma application, and/or the CrossPort application operated by Snacks After Midnight</li>
